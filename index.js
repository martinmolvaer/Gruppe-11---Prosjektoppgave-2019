...
function addItemTodo(text){
  ...
  var infoSVG = "<?xml version='1.0' encoding='UTF-8'?><!DOCTYPE svg  PUBLIC '-//W3C//DTD SVG 1.1//EN'  'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'><svg enable-background='new 0 0 510 510' version='1.1' viewBox='0 0 510 510' xml:space='preserve' xmlns='http://www.w3.org/2000/svg'><path d='m255 0c-140.25 0-255 114.75-255 255s114.75 255 255 255 255-114.75 255-255-114.75-255-255-255zm25.5 382.5h-51v-153h51v153zm0-204h-51v-51h51v51z'/></svg>"
...
itemContainers.forEach(function (container) {
  ...
  // Instantiate column grid.
    ...
    dragStartPredicate:{distance: 0, delay: 70, handle: true},
    dragSortInterval: 0,
