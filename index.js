...
document.getElementById('add').addEventListener('click', function(){
  ...
  var labelGet = document.getElementById('viktig').value;
...
/*
  ...
  label.classList = 'board-item';
  label.classList = 'board-item-content'; */  
